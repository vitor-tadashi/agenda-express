...
<div id="wrapper">
    ...
    <div id="top-nav" class="skin-6 fixed">
			<div class="brand">
				<span>Agenda</span>
				<span class="text-toggle">Express</span>
			</div><!-- /brand -->
			...
			<ul class="nav-notification clearfix">
				...
				<li class="profile dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a tabindex="-1" class="main-link logoutConfirm_open" href="#logoutConfirm" data-popup-ordinal="0" id="open_14157492"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
					</ul>
				</li>
			</ul>
		</div> 
